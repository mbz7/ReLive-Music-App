...
c1 = Concert.create!(user_id: u1, band: 'Red Hot Chili Peppers', venue: "Globe Life Field", location: 'Arlington, TX', date: '09/18/2022')
c2 = Concert.create!(user_id: u1, band: 'Red Hot Chili Peppers', venue: "SoFi Stadium", location: 'Inglewood, CA', date: '09/08/2022')
c3 = Concert.create!(user_id: u1, band: 'Red Hot Chili Peppers', venue: "Nationals Park", location: 'Washington, D.C.', date: '07/31/2022')
